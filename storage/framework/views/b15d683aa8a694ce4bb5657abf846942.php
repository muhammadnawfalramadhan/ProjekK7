...
<header class="flex items-center justify-between p-5 bg-white border-b border-gray-200 shadow-md">
    ...
    <div class="flex items-center space-x-3">
        <span class="font-semibold text-gray-700">
            Halo, <?php echo e(session('username')); ?>👋
        </span>
        <div
            class="w-8 h-8 bg-green-800 text-white flex items-center justify-center rounded-full font-bold uppercase">
            <?php echo e(substr(session('username'), 0, 2)); ?>

        </div>
    </div>
</header><?php /**PATH D:\Intanlestari24TIG2\laragon-6.0-minimal\www\ProjekK7\resources\views/admin/layouts/admin/header.blade.php ENDPATH**/ ?>