            ...
            <div class="col-md-5 col-sm-10">
                <div class="card login-card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('auth.login')); ?>" method="POST" autocomplete="on">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
                    ...
                    <div class="card-footer">
                        <p class="mb-0">Belum punya akun?
                            <a href="<?php echo e(route('auth.registerForm')); ?>" class="text-success fw-semibold">Register</a>
                        </p>
                    </div>
                </div>
            </div>
...
<?php /**PATH D:\Intanlestari24TIG2\laragon-6.0-minimal\www\ProjekK7\resources\views/TukangTimbang/login-form.blade.php ENDPATH**/ ?>