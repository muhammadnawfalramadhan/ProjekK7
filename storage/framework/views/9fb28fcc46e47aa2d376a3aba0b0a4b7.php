...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
    ...
    <div
        ...
        <p class="text-4xl font-extrabold text-gray-900 mt-2"><?php echo e($totalTBS ?? '0'); ?></p>
    ...
    <div
        ...
        <p class="text-4xl font-extrabold text-gray-900 mt-2"><?php echo e($totalPetani ?? '0'); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
    ...
    <div class="lg:col-span-1 bg-white p-6 rounded-xl shadow-xl flex flex-col">
        ...
        <div class="space-y-3 flex-1">
            <a href="<?php echo e(route('admin.harga.create')); ?>"
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <!-- Menu 1: Harga TBS -->
    <a href="<?php echo e(route('admin.harga.index')); ?>" class="block bg-white p-6 rounded-xl shadow-xl border-l-4 border-yellow-500 hover:shadow-2xl transition duration-300">
    ...
    <a href="<?php echo e(route('admin.timbangan.index')); ?>" class="block bg-white p-6 rounded-xl shadow-xl border-l-4 border-lime-500 hover:shadow-2xl transition duration-300">
        <div class="flex items-center mb-3">
    ...
    <a href="<?php echo e(route('admin.pengguna.index')); ?>" class="block bg-white p-6 rounded-xl shadow-xl border-l-4 border-green-700 hover:shadow-2xl transition duration-300">
        <div class="flex items-center mb-3">
    ...
    <!-- Menu 4: Laporan -->
    <a href="<?php echo e(route('admin.laporan.index')); ?>" class="block bg-white p-6 rounded-xl shadow-xl border-l-4 border-blue-500 hover:shadow-2xl transition duration-300">
        <div class="flex items-center mb-3">
...
<?php echo $__env->make('admin.layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Intanlestari24TIG2\laragon-6.0-minimal\www\ProjekK7\resources\views/admin/pages/dashboard.blade.php ENDPATH**/ ?>