...
<body>
    ...
    <div class="sidebar">
        <h4>🌴 Pekerja</h4>
        <a href="{{ route('tukang.dashboard') }}"><i class="bi bi-house-door-fill"></i> <span>Dashboard</span></a>
        <a href="{{ route('tukang.input') }}"><i class="bi bi-plus-square-fill"></i> <span>Input Timbangan</span></a>

        <!-- MENU AKTIF -->
        <a href="#" class="active"><i class="bi bi-file-earmark-text"></i> <span>Data Timbangan</span></a>

        <a href="{{ route('auth.logout') }}"><i class="bi bi-box-arrow-right"></i> <span>Logout</span></a>
    </div>
    ...
    <div class="main-content">
        ...
        <div class="card filter-card">
            ...
            <form action="{{ route('tukang.data') }}" method="GET">
                <div class="row g-3 align-items-end">
                    ...
                    <div class="col-md-4 d-flex gap-2">
                        ...
                        <a href="{{ route('tukang.data') }}" class="btn btn-secondary"><i class="bi bi-arrow-counterclockwise"></i></a>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                <div class="card text-white p-4 border-0 rounded-4 shadow-sm h-100" style="background-color: #198754;">
                    ...
                    <h1 class="fw-bold m-0">{{ $dataTimbangan->sum('berat') }} Kg</h1>
                </div>
            </div>
            <!-- Kartu Kuning -->
            <div class="col-md-6">
                <div class="card text-dark p-4 border-0 rounded-4 shadow-sm h-100" style="background-color: #ffc107;">
                    ...
                    <h1 class="fw-bold m-0">{{ $dataTimbangan->count() }}</h1>
                </div>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle table-bordered">
                    ...
                    <tbody>
                        ...
                        @if($dataTimbangan->count() > 0)
                        <tr class="fw-bold table-light">
                            <td colspan="3" class="text-end">GRAND TOTAL:</td>
                            <td>{{ $dataTimbangan->sum('berat') }} Kg</td>
                            <td></td>
                        </tr>
                        @endif
                    </tbody>
        ...
        <footer class="mt-5 pt-4 border-top text-center text-secondary">
            <p class="mb-1">&copy; {{ date('Y') }} <strong>Web Sawit</strong>. All Rights Reserved.</p>
