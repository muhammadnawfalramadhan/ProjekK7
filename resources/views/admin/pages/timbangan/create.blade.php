...
<style>
    ...
    .form-control:focus {
        ...
        /* Putih saat fokus */
        box-shadow: 0 0 0 0.25rem rgba(15, 171, 88, 0.25);
    }

    .card-form {
        background: #ffffff;
        border: none;
        border-top: 6px solid #0fab58;
        /* Garis hijau di atas lebih tebal */
        border-radius: 12px;
    ...
    .form-title {
        ...
        /* Ukuran lebih besar */
        padding-bottom: 10px;
        border-bottom: 3px solid #0fab58;
        margin-bottom: 30px;
        display: flex;
        align-items: center;
    }
    ...
    /* Styling untuk tombol Simpan (Submit) */
    .btn-submit {
        background: linear-gradient(90deg, #0fab58, #0b8f52);
        border: none;
        color: white;
        font-weight: 700;
        padding: 12px 35px;
        border-radius: 10px;
        transition: all 0.3s;
        box-shadow: 0 4px 10px rgba(15, 171, 88, 0.4);
    }

    .btn-submit:hover {
        background: linear-gradient(90deg, #0a9d4e, #0a7a46);
        transform: translateY(-2px);
        /* Efek lift */
        box-shadow: 0 6px 15px rgba(15, 171, 88, 0.5);
    }
...
<div class="container mt-4">
    ...
    <h3 class="form-title">
        <i class="fas fa-plus-circle"></i> Input Data Timbangan Baru
    </h3>
    ...
    <div class="card shadow p-5 mt-3 card-form">
        ...
        <form action="{{ route('admin.datatimbangan.store') }}" method="POST">
            @csrf

            <div class="row">
                {{-- Field Kode Transaksi (Hanya Info) --}}
                <div class="col-md-6">
                    <div class="mb-4">
                        <label class="form-label font-weight-bold text-muted">Kode Transaksi</label>
                        <input type="text" class="form-control readonly-field" value="Akan Dibuat Otomatis oleh Sistem" readonly>
                    </div>
                </div>
                {{-- Field Tanggal --}}
                <div class="col-md-6">
